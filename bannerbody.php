            ...
            <td id="top_menu">
                <div>
                  ...
                  /*  echo ' | <a class="menu_action" href="ldap/edit.php?id=' . $user . '&lang='
                    ...
                    . ">$user [" . $access_labels['privLabels'][$lang][$userAccessLevel + 1] . "]</a> "; */

                    echo ' | <a class="menu_action" target="_blank" href="'.$_SESSION['openmrs_user']->settings.'">'.$_SESSION['openmrs_user']->display.'</a> ';

                    echo "| <a class=\"menu_action\" href=";
